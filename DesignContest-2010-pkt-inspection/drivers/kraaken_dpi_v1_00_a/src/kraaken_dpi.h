//////////////////////////////////////////////////////////////////////////////
// Filename:          E:\work\FPGA_PROJECTS\ML509\ml509_dpi/drivers/kraaken_dpi_v1_00_a/src/kraaken_dpi.h
// Version:           1.00.a
 ...
 */
#define KRAAKEN_DPI_SOFT_RST_SPACE_OFFSET (0x00000100)
#define KRAAKEN_DPI_RST_REG_OFFSET (KRAAKEN_DPI_SOFT_RST_SPACE_OFFSET + 0x00000000)
 ...
 */
#define KRAAKEN_DPI_INTR_CNTRL_SPACE_OFFSET (0x00000200)
 ...
 */
#define KRAAKEN_DPI_WRFIFO_REG_SPACE_OFFSET (0x00000300)
...
#define KRAAKEN_DPI_WRFIFO_DATA_SPACE_OFFSET (0x00000400)
...
/**
 *
 * Reset KRAAKEN_DPI via software.
 *
 * @param   BaseAddress is the base address of the KRAAKEN_DPI device.
 *
 * @return  None.
 ...
 * @note
 * C-style signature:
 * 	void KRAAKEN_DPI_mReset(Xuint32 BaseAddress)
 *
 */
#define KRAAKEN_DPI_mReset(BaseAddress) \
 	XIo_Out32((BaseAddress)+(KRAAKEN_DPI_RST_REG_OFFSET), SOFT_RESET)
