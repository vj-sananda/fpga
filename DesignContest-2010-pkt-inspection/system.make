...
# E:\work\FPGA_PROJECTS\ML509\xupv5_kraaken_v1\system.mhs
# The software specification of the system is in file :
# E:\work\FPGA_PROJECTS\ML509\xupv5_kraaken_v1\system.mss
...
canscid_dpi_program: $(CANSCID_DPI_OUTPUT) 

$(CANSCID_DPI_OUTPUT) : $(CANSCID_DPI_SOURCES) $(CANSCID_DPI_HEADERS) $(CANSCID_DPI_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/canscid_dpi_compiler.opt
	@mkdir -p $(CANSCID_DPI_OUTPUT_DIR) 
	$(CANSCID_DPI_CC) $(CANSCID_DPI_CC_OPT) $(CANSCID_DPI_SOURCES) -o $(CANSCID_DPI_OUTPUT) \
	$(CANSCID_DPI_OTHER_CC_FLAGS) $(CANSCID_DPI_INCLUDES) $(CANSCID_DPI_LIBPATH) \
	$(CANSCID_DPI_CFLAGS) $(CANSCID_DPI_LFLAGS) 
	$(CANSCID_DPI_CC_SIZE) $(CANSCID_DPI_OUTPUT) 
	@echo ""

canscid_dpi_programclean:
	rm -f $(CANSCID_DPI_OUTPUT) 
