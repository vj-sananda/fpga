------------------------------------------------------------------------------
-- example_fifo_loopback_vhdl.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          example_fifo_loopback_vhdl.vhd
-- Version:           1.00.a
...
library example_fifo_loopback_vhdl_v1_00_a;
use example_fifo_loopback_vhdl_v1_00_a.user_logic;
...
entity example_fifo_loopback_vhdl is
  generic
  (
...
end entity example_fifo_loopback_vhdl;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of example_fifo_loopback_vhdl is
  ...
  ------------------------------------------
  constant USER_RDFIFO_DEPTH              : integer              := 128;
  ...
  ------------------------------------------
  constant USER_WRFIFO_DEPTH              : integer              := 128;
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity example_fifo_loopback_vhdl_v1_00_a.user_logic
    generic map
    (
  ...
  ------------------------------------------
  IP2BUS_DATA_MUX_PROC : process( ipif_Bus2IP_CS, user_IP2Bus_Data, intr_IP2Bus_Data, rff_IP2Bus_Data, wff_IP2Bus_Data ) is
  begin

    case ipif_Bus2IP_CS is
      when "100000" => ipif_IP2Bus_Data <= user_IP2Bus_Data;
      when "010000" => ipif_IP2Bus_Data <= intr_IP2Bus_Data;
  ...
  ipif_IP2Bus_WrAck <= user_IP2Bus_WrAck or intr_IP2Bus_WrAck or rff_IP2Bus_WrAck or wff_IP2Bus_WrAck;
  ipif_IP2Bus_RdAck <= user_IP2Bus_RdAck or intr_IP2Bus_RdAck or rff_IP2Bus_RdAck or wff_IP2Bus_RdAck;
  ipif_IP2Bus_Error <= user_IP2Bus_Error or intr_IP2Bus_Error or rff_IP2Bus_Error or wff_IP2Bus_Error;
