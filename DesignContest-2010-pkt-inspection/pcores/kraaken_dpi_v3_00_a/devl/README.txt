...
Peripheral Summary:
  ...
  logical library name                       : kraaken_dpi_v3_00_a
  top name                                   : kraaken_dpi
  version                                    : 3.00.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/kraaken_dpi_xst.prj
...
- Driver interface file(s)
  ...
  data/kraaken_dpi_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/kraaken_dpi_v2_1_0.tcl
