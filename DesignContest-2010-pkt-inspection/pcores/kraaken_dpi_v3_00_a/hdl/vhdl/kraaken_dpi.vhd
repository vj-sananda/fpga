------------------------------------------------------------------------------
-- kraaken_dpi.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          kraaken_dpi.vhd
-- Version:           3.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Tue Mar 30 01:00:56 2010 (by Create and Import Peripheral Wizard)
...
end entity kraaken_dpi;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of kraaken_dpi is
...
begin
  ...
  begin
    ...
    case ipif_Bus2IP_CS is
      ...
      when "0010" => ipif_IP2Bus_Data <= wff_IP2Bus_Data;
      when "0001" => ipif_IP2Bus_Data <= wff_IP2Bus_Data;
