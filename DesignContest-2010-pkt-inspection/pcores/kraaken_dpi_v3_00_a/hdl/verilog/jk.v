...
`include "fired_wire_decl.vh"
   ...
   always @*
	...
	case(STATE)
	  ...
	  //Pipe Delay
	  REGEX_FINALIZE_CATEGORY_D1: NEXT_STATE = REGEX_FINALIZE_CATEGORY ;
	  ...
	  //Pipe delay
	  REGEX_FINALIZE_D1: NEXT_STATE = REGEX_FINALIZE ;
   ...
   always @(posedge clk)
     begin
	char_in_1 <= regex_char_rc ;
	char_in_2 <= regex_char_rc ;
	char_in_3 <= regex_char_rc ;
	char_in_4 <= regex_char_rc ;
	char_in_5 <= regex_char_rc ;
	char_in_6 <= regex_char_rc ;
	char_in_7 <= regex_char_rc ;
	char_in_8 <= regex_char_rc ;
	char_in_9 <= regex_char_rc ;
	char_in_10 <= regex_char_rc ;
	char_in_11 <= regex_char_rc ;
	char_in_12 <= regex_char_rc ;   	  	  
     end
