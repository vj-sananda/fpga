...
//type fifo_cntl_sm_type
  ...
  assign ip2bus_toutsup     = 0;
   ...
   wire [c_width-1:0] 	idata = ldata_rd ;			// to dut of huffman_decode.v
   
   /*autoreg*/

   /*autowire*/
   // Beginning of automatic wires (for undeclared instantiated-module outputs)
   wire [3:0]		code;			// From huffman_decode_i of huffman_decode.v
   wire			pop;			// From huffman_decode_i of huffman_decode.v
   wire			push;			// From huffman_decode_i of huffman_decode.v
   // End of automatics
  ...
  always @( posedge bus2ip_clk )
   ...
   huffman_decoder_v1 huffman_decode_i (/*AUTOINST*/
				    // Outputs
				    .code		(code[3:0]),
				    .push		(push),
				    .pop		(pop),
   ...
   always @ (/*autosense*/
	     fifo_cntl_cs or ldata_rd or pop or rfifo2ip_full
...
//            if (((wfifo2ip_empty == 1'b0) & (rfifo2ip_full == 1'b0)))
   ...
   always @(/*AUTOSENSE*/code
	    or fifo_wr_cntl_cs or push or result_rd or rfifo2ip_full
	    or rfifo2ip_wrack)
     begin
	result_wd = result_rd ;
