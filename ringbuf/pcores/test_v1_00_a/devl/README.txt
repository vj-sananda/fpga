...
File Summary
  ...
  - HDL source -
  C:\work\ringbuf\pcores\test_v1_00_a\hdl\vhdl
  top level      : test.vhd

  - XPS interface -
  C:\work\ringbuf\pcores\test_v1_00_a\data
  mpd            : test_v2_1_0.mpd
  pao            : test_v2_1_0.pao

  - ISE project -
  C:\work\ringbuf\pcores\test_v1_00_a\devl\projnav
  ise project    : test.npl
  cli command    : test.cli


  - XST synthesis -
  C:\work\ringbuf\pcores\test_v1_00_a\devl\synthesis
  xst script     : test_xst.scr
  xst project    : test_xst.prj

  - Misc file -
  C:\work\ringbuf\pcores\test_v1_00_a\devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log

  - Driver source -
  C:\work\ringbuf\drivers\test_v1_00_a\src
  makefile       : Makefile
  header         : test.h
  source         : test.c

  - Driver interface -
  C:\work\ringbuf\drivers\test_v1_00_a\data
  mdd            : test_v2_1_0.mdd
  tcl            : test_v2_1_0.tcl
...
written into src/test.c in the Driver Directory.
...
implemented in hdl/vhdl/test.vhd in the Core Directory.
